...
- `dist/zotero-ablesci-assistant-0.1.5.xpi`
- `dist/ablesci-chromium-extension-0.1.5.zip`
...
4. 选择 `dist/zotero-ablesci-assistant-0.1.5.xpi`。
5. 按提示重启 Zotero。
6. 确认工具栏出现“科研通求助”，文献右键菜单出现“在科研通发起文献求助”。

## 安装 Chrome 扩展

1. 解压 `dist/ablesci-chromium-extension-0.1.5.zip`，或直接使用 `dist/chromium/`。
